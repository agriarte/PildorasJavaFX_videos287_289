 ...
 */
public class Video288_289_estiloscss extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        //asignar un ID al text, como hay una descripción de css
        ...
        //aplicar clases de css a elementos concretos
        lblNombre.getStyleClass().add("miEstiloPropio");
        ...
        //estilo css inline desde java
        btnOK.setStyle("-fx-font-size: 20");

        Button btnCancelar = new Button("Cancelar");
        btnCancelar.setPrefWidth(80);
        btnCancelar.setOnAction(e -> btn_Cancelar_Click());
        
        //asignar un ID para que se aplica un css por selector de id
        btnCancelar.setId("boton_cancelar");
        ...
        //Para NETBEANS y MAVEN los archivos externos .css deben guardarse enen "src/main/resources/css".
        //Después es recomendable hacer un "Clean and build"
        //En la pestaña de proyectos el directorio css aparece dentro de "Other Sources> src/main/resources
        //En cualquier otro sitio netbeans no encontrará los archivos css, ni siquiera poniendo la ruta absoluta.
        String cssPath = "/css/misEstilos.css";
        URL resourceUrl = getClass().getResource(cssPath);
        //Resource URL: file:/G:/JAVA/proyectosnetbean/JavaFX_EstilosCSS_Videos287_289/target/classes/css/misEstilos.css 
        //Atencion a que el archivo css que tomará es el que ha copiado dentro de .../target/classes/css/misEstilos.css 
